...
<head>
    ...
    <title>@yield('title', 'AsBeez POS • Home')</title>
...
<body>
    <header class="topbar">
        ...
        <div class="top-right">
            ...
            <span id="currentCashier" style="font-weight:800;">
                Employee: <span style="font-weight:500;">{{ session('pos_employee_name') ?? 'Not signed
                    in' }}</span>
            </span>
            @php
            ...
            @endphp
            <span class="text-sm" style="margin-left:12px;">Branch: <span style="font-weight:500;">{{ $displayBranchCode
                    ?? 'N/A' }}</span></span>
            @yield('top-right')
        </div>
    </header>
