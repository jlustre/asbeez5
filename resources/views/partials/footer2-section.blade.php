<footer class="section-t-space">
    <div class="container-fluid-lg">
                        ...
                        <div class="footer-logo-contain">
                            ...
                            <ul class="address">
                                <li>
                                    ...
                                    <a href="javascript:void(0)">{{ config('company.address') }}</a>
                                </li>
                                <li>
                                ...
                                <ul>
                                    <li class="mb-0">
                                        <a href="https://play.google.com/store/apps" target="_blank">
                                            <img src="{{ asset('assets/images/playstore.svg') }}"
        ...
        <div class="sub-footer section-small-space">
            <div class="reserve">
                <h6 class="text-content">©2026 {{ config('app.name') }} All rights reserved</h6>
            </div>
