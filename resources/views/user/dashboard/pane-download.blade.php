                ...
                <ul class="nav nav-pills filter-box" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-data-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-data" type="button">Data Purchased</button>
                    </li>
                    <li class="nav-item" role="presentation">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>
                                            <img src="{{ asset('assets/images/theme-icon/1.png') }}" class="img-fluid"
                                                alt="">
                                        </td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>
                                            <img src="{{ asset('assets/images/theme-icon/2.png') }}" class="img-fluid"
                                                alt="">
                                        </td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>
                                            <img src="{{ asset('assets/images/theme-icon/3.png') }}" class="img-fluid"
                                                alt="">
                                        </td>
