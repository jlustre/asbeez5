    ...
    <div class="dashboard-order">
        ...
        <div class="order-contain">
            <div class="order-box dashboard-bg-box">
                ...
                <div class="product-order-detail">
                    <a href="product-left-thumbnail.html" class="order-image">
                        <img src="{{ asset('assets/images/vegetable/product/1.png') }}" class="blur-up lazyload" alt="">
                    </a>
            ...
            <div class="order-box dashboard-bg-box">
                ...
                <div class="product-order-detail">
                    <a href="product-left-thumbnail.html" class="order-image">
                        <img src="{{ asset('assets/images/vegetable/product/2.png') }}" alt="" class="blur-up lazyload">
                    </a>
            ...
            <div class="order-box dashboard-bg-box">
                ...
                <div class="product-order-detail">
                    <a href="product-left-thumbnail.html" class="order-image">
                        <img src="{{ asset('assets/images/vegetable/product/3.png') }}" alt="" class="blur-up lazyload">
                    </a>
            ...
            <div class="order-box dashboard-bg-box">
                ...
                <div class="product-order-detail">
                    <a href="product-left-thumbnail.html" class="order-image">
                        <img src="{{ asset('assets/images/vegetable/product/4.png') }}" class="blur-up lazyload" alt="">
                    </a>
